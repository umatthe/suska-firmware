...
#include "config.h"
#ifndef get_fattime
#define get_fattime get_fattime_default
#endif
#ifndef MINIMIZE_LEVEL
...
#define _FS_READONLY	READONLY	/* 0 or 1 */
/* Setting _FS_READONLY to 1 defines read only configuration. This removes
/  writing functions, f_write, f_sync, f_unlink, f_mkdir, f_chmod, f_rename,
/  f_truncate and useless f_getfree. */


#define _FS_MINIMIZE	MINIMIZE_LEVEL	/* 0, 1, 2 or 3 */
...
#define	_USE_STRFUNC	USE_STRFUNC	/* 0, 1 or 2 */
...
#define	_USE_LFN	USE_LFN		/* 0, 1 or 2 */
#define	_MAX_LFN	MAX_LFN		/* Maximum LFN length to handle (12 to 255) */
